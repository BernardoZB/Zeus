...
(function ($) {
  ...
  $.fn.mfnMenu = function (options) {
    ...
    var init = function init() {
      // add '.submenu' class
      $("li:has(ul)", menu).addClass("submenu"); // append mobile toggle button

      $("li:has(ul)", menu).append('<span class="menu-toggle"></span>'); // add '.mfn-megamenu-parent' class

      menu.children("li:has( ul.mfn-megamenu )").addClass("mfn-megamenu-parent"); // add '.last-item' class

      $(".submenu ul li:last-child", menu).addClass("last-item"); // add '.last' class
